...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['???', 0.6], //From 50% to 59%
		['IDK', 0.69], //From 60% to 68%
		['Nice :)', 0.7], //69%
		['Okay', 0.8], //From 70% to 79%
		['Good', 0.9], //From 80% to 89%
		['Awesome!', 1], //From 90% to 99%
		['Immaculate!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "ROBOT MODE", 32);
